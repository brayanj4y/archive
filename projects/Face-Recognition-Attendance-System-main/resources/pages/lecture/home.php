...
<body>
    ...
    <section class="main">
        ...
        <div class="main--content">
            ...
            <p style="font:80px; font-weight:400; color:blue; text-align:center; padding-top:2px;">Please select Role,
                Department, and Workstation first. Before Launching Facial Recognition</p>
            <form class="lecture-options" id="selectForm">
                ...
                <select required name="venue" id="venueSelect" onChange="updateTable()">
                    <option value="" selected>Select Workstation</option>
                    <?php
