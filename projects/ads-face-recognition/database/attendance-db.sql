...
VALUES
  (
    ...
    '',
    'admin@gmail.com',
    '$2y$10$FIBqWvTOXRMoQOAB2FBz3uUbaCwRYTM1zQreFI6i/7v6Qi8y9R1i6'
  );
...
VALUES
  (
    ...
    'lila',
    'mark@gmail.com',
    '$2y$10$/st06w2mh/4adxGE9yCxROHkqHp6SzRARGhfCIg95zC3cxqbmkpaW',
    '07123456789',
    'CIT',
    '2024-04-07'
  );
...
--
ALTER TABLE `tblattendance` ADD PRIMARY KEY (`attendanceID`);

--
-- Indexes for table `tblcourse`
--
ALTER TABLE `tblcourse` ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `tblfaculty`
--
ALTER TABLE `tblfaculty` ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `tbllecture`
--
ALTER TABLE `tbllecture` ADD PRIMARY KEY (`Id`);
...
--
ALTER TABLE `tblunit` ADD PRIMARY KEY (`Id`);

--
-- Indexes for table `tblvenue`
--
ALTER TABLE `tblvenue` ADD PRIMARY KEY (`Id`);
...
--
ALTER TABLE `tblattendance` MODIFY `attendanceID` int(50) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 511;

--
-- AUTO_INCREMENT for table `tblcourse`
--
ALTER TABLE `tblcourse` MODIFY `Id` int(50) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 20;

--
-- AUTO_INCREMENT for table `tblfaculty`
--
ALTER TABLE `tblfaculty` MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 16;

--
-- AUTO_INCREMENT for table `tbllecture`
--
ALTER TABLE `tbllecture` MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 24;

--
-- AUTO_INCREMENT for table `tblstudents`
--
ALTER TABLE `tblstudents` MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 129;

--
-- AUTO_INCREMENT for table `tblunit`
--
ALTER TABLE `tblunit` MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 10;

--
-- AUTO_INCREMENT for table `tblvenue`
--
ALTER TABLE `tblvenue` MODIFY `Id` int(10) NOT NULL AUTO_INCREMENT,
AUTO_INCREMENT = 16;
