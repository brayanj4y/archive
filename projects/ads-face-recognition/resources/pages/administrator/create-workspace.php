...
if (isset($_POST["addVenue"])) {
    ...
    if (!$className || !$facultyCode || !$currentStatus || !$capacity || !$classification) {
        ...
        try {
            ...
            if ($stmt->rowCount() > 0) {
                $_SESSION['message'] = "Workstation Already Exists";
            } else {
                ...
                if ($stmt->execute()) {
                    $_SESSION['message'] = "Workstation Inserted Successfully";
                } else {
                    $_SESSION['message'] = "Failed to Insert Workstation.";
                }
            }
                ...
                <form method="POST" action="" name="addVenue" enctype="multipart/form-data">
                    <div style="display:flex; justify-content:space-around;">
                        <div class="form-title">
                            <p>Add Meeting room</p>
                        </div>
                        <div>
                            <span class="close">&times;</span>
                        </div>
                    </div>
                    <input type="text" name="className" placeholder="Meeting name" required>
                    ...
                    <input type="submit" class="submit" value="Save Meeting room" name="addVenue">
                </form>
            </div>
        </div>
    </section>
