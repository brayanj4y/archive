            ...
            <div className="space-y-6">
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">
                    We encourage you to see your puppy via video call or visit us in person in Portland, OR. This helps
              ...
              <div className="flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-3">
                    Decide whether you'd like to pick up your puppy in Portland, OR, or use our travel nanny service
